    ...
    <>
      ...
      <main>
        ...
        <section id="musica">
          ...
          <div
            className="md:hidden flex flex-col justify-start px-6 pt-10"
            style={{ backgroundImage: "url('/images/musica-mobile.jpg')", backgroundSize: "cover", backgroundPosition: "center top", minHeight: "980px" }}
          >
              ...
              <div>
                ...
                <div className="space-y-5">
                  ...
                  >
                    ...
                    <span className="text-base">paulamicrofisioterapia@gmail.com</span>
                  </a>
                  <a
